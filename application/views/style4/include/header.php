        ...
        <div class="col-md-12 p-0 bottom_30">
            <div class="profile-usermenu">
                <ul class="nav">
                    ...
                    <li class="tab <?php if(isset($page_title) && $page_title == 'About me'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/about-me/'.html_escape($user->slug)) ?>"><i class="fa fa-user"></i> About me</a></li>
                    <li class="tab <?php if(isset($page_title) && $page_title == 'Resume'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/resume/'.html_escape($user->slug)) ?>"><i class="fa fa-id-card-o"></i> Resume</a></li>

                    <li class="tab <?php if(isset($page_title) && $page_title == 'Portfolio'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/portfolio/'.html_escape($user->slug)) ?>"><i class="fa fa-image"></i> Portfolio</a></li>
                    <li class="tab <?php if(isset($page_title) && $page_title == 'Blog Posts' || $page_title == 'Post details'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/blog/'.html_escape($user->slug)) ?>"><i class="fa fa-comments-o"></i> Blog</a></li>
                    <li class="tab <?php if(isset($page_title) && $page_title == 'Contact'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/contact/'.html_escape($user->slug)) ?>"><i class="fa fa-map-marker"></i> Contact</a></li>
                    <li class="tab <?php if(isset($page_title) && $page_title == 'Appointment'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('profile/appointment/'.html_escape($user->slug)) ?>"><i class="fa fa-calendar"></i> Appoinment</a></li>
                </ul>
            </div>
        </div>
