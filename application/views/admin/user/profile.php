      ...
      <div class="col-xl-3 col-lg-3">
        ...
        <div class="box">
          <div class="box-body box-profile">
            ...
            <center><button id="pay-button" class="btn btn-success">Bayar Sekarang</button></center>
                ...
                <div class="active tab-pane" id="content1">
                  ...
                  <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="example-input-normal">Provinsi</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="example-input-normal">Kabupaten</label>
                            <div class="col-sm-12">
                              <input type="hidden" id="nama_kabupaten" name="kabupaten">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="example-input-normal">Kecamatan</label>
                            <div class="col-sm-12">
                              <input type="hidden" id="nama_kecamatan" name="kecamatan">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="example-input-normal">Kelurahan / Desa</label>
                            <div class="col-sm-12">
                              <input type="hidden" id="nama_kelurahan" name="kelurahan">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="example-input-normal">Kode Pos</label>
                            <div class="col-sm-12">
                                <input type="text" name="kodepos" class="form-control" value="<?php echo $user->kodepos; ?>">
                            </div>
                        </div>
                        <div class="form-group">
