        ...
        <div class="row">
            ...
            <div class="card h-100 hover-box-shadow">
              <a href="#" class="d-block bg-gradient rounded-top">
                <img class="card-img-top hover-fade-out" src="<?php echo base_url() ?>assets/front/img/blog/thumb-8.jpg" alt="blog.6.image">
              </a>
              <div class="card-body">
                <a href="#">
                  <h3>Willy Setiawan</h3>
                </a>
                <section class="bg-light p-0 row no-gutters text-center">
                  <div class="col-sm-3">
                    1
                  </div>
                  <div class="col-sm-3">
                                            ...
                                            <?php if ($this->session->userdata('logged_in') == TRUE): ?>
                                                <?php $follow = check_follower($user->id); ?>
                                                    <div class="card-btns text-center">
                                                        ...
                                                        <?php endif ?>
                                                        <a target="_blank" href="<?php echo base_url('profile/'.$user->slug) ?>" class="btn default"><i class="fa fa-eye"></i> View Profile</a>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="card-btns text-center">
