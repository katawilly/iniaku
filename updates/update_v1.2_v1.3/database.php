...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
      ...
      mysqli_query($connection, "UPDATE settings SET version = 'v1.3' WHERE id = 1;");
      mysqli_query($connection, "ALTER TABLE users ADD COLUMN `hit` int DEFAULT 0 AFTER status;");
      mysqli_query($connection, "ALTER TABLE users ADD COLUMN `enable_followers` int DEFAULT 0 AFTER enable_appointment;");
      mysqli_query($connection, "ALTER TABLE users ADD COLUMN `layouts` varchar(255) DEFAULT 'style1' AFTER hit;");
      ...
      $redir = str_replace('updates/update_v1.2_v1.3/', '', $redir);
